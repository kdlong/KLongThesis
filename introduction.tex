...
Marie and Pierre Curie, and Rutherford~\cite{}, 
...
spin is quantized.
The electron and proton spins are always observed to be $\pm\hbar$, where 
$\hbar=6.626\times 10^{-34}\unit{J}\cdot\mathrm{s}$
is the Planck constant.
We refer to such particles, with half-interger spin as \emph{fermions}. Particles
...
that a third particle, over very low mass and uncharged, also participated
in the interaction, 
He prosed a direct four-fermion interaction between the 
that fermions could be created or destroyed in an interaction,
...
outside the atmosphere. The discovery of the positron in 1932~\cite{}
and the muon in 1936~\cite{} by Carl Anderson were made from such studies.
...
positive charge, had been predicted by Dirac a year earlier~\cite{}, but
...
now known as hadrons, was described by Gell-Man and Zweig in 1964~\cite{}.
...
with the properties Gell-Man and Zweig predicted~\cite{}.
...
the electromagnetic interaction: weak interactions extends over a much smaller
...
contributions from Sheldon Glashow, Abdus Salam, and Steven Weinberg~\cite{}.
...
Confirmation of this mechanism, originally proposed by Higgs, Brout, Englert, Kibbel,
...
David Gross, David Politzer and Frank Wilczek~\cite{}
overcame its computational complexity to demonstrate the required
inverse distance scaling properties of the theory in 1973~\cite{}. 
...
\begin{itemize}
  \item The gluon, the vector boson of the QCD theory, discovered
      at PETRA collider at Deutsches Elektronen-Synchrotron by the TASSO experiment~\cite{}, which provided
      conclusive support of QCD as a quantum gauge theory
  \item The discoveries of the $\Wpm$ and $\PZ$ bosons, the massive vector bosons of the weak interaction,
    discovered by the UA1 experiment at the LEP collider at the European Center for Nuclear Research (CERN).
  \item The discovery of the top quark, the heaviest fundamental particle, by the D0 and CDF Collaborations
    at the Tevatron collider at Fermilab~\cite{}.
\end{itemize}
...
the up-quark ($\cPu$), down quark ($\cPd$), and electron (e$^{-}$).
...
or mirror symmetry, first observed experimentally by Wu~\cite{} by
measuring the $\beta$ decays of cobalt-60 (based on a proposal by Lee and Yang~\cite{}).
