...
of Geneva, Switzerland, in the nearby French and Swiss countryside,
...
in the project, including the United States~\cite{}.
...
for shielding the radiation produced by the LHC~\cite{}. 
...
collider in 1959, where the protons reach 25\GeV. The PS feeds the Super Proton Synchrotron,
...
The field oscillations leads to larger or weaker kick applied to in and out of time protons,
...
which can be stored in the LHC. However, when removing the proton beam from the LHC,
it is necessary to direct the beam
away from its nominal path to deposit its energy in a controlled way
to avoid damaging the LHC cryogenic system. This process, known as a beam dump,
...
In 2016, the LHC delivered proton--proton collision at $\sqrt{s} = 13\TeV$ from
April 22 to October 27. During this time, the proton beams were circulating in the
LHC for about 75\% of the time, and with the majority of the time devoted to
...
However, operation at $\sqrt{13}\TeV$ is below the design energy of $\sqrt{s}=14\TeV$.
...
collisions at 14\TeV are envision beginning in 2021.
...
Integrated luminosity is generally measured in cm${-24}$ or b$^{-1}$,
...
\begin{equation}
  ...
  \label{eq:lumi}
\end{equation}
Assuming the beams have Gaussian profile, and introducing the variables
