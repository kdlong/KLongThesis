...
true value $\mu$ from which the data are drawn cannot be inferred precisely
...
where the dependence of the expected event yield on underlying parameters
of the model is now made explicit.
...
outcome of an experiment. All results presented in this analysis
use a binned likelihood function, which is a product of the probability
distribution function per bin. 

Comments about nuisance parameters

All interpretations of results in terms of 
the SM predictions and BSM extensions presented this thesis 
