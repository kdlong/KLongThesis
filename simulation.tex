...
The results in this thesis exploit the data to constrain important backgrounds.
...
an accurate description of the two-jet kinematics of the \WZjj state is achieved without
...
top quark production. These techniques have been extensively validated
with measurements of $\PW$ and $\PZ$ production~\cite{ATL-PHYS-PUB-2017-006}, as well
as in diboson states at in \pp and \ppbar collisions~\cite{Sirunyan:2019bez,PhysRevD.91.111101}.
...
more than ten years ago~\cite{Bozzi:2007ur}, however, only recently have these
results been implemented in a form that is compatible with simulations of the parton shower and 
hadronization~\cite{Jager:2018cyo}. Recent 
results considering both NLO EW and QCD effects for \WZjj production 
are also limited to fixed order~\cite{Denner:2019tmn}.
