...
operators in the \WZ channel at 13\TeV. The results
of are comparable and complementary to studies performed
by the ATLAS and CMS Collaborations using other production and decay channels.
The 95\% CL limit on the coupling parameters placed on the transverse operator T1
is f$_{\text{T1}}/\Lambda^4 \in [-0.56, 0.60]$, compared with the confidence intervals
